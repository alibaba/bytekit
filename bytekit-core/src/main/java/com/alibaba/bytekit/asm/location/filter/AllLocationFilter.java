...
public class AllLocationFilter implements LocationFilter {

    private List<LocationFilter> filters = new ArrayList<LocationFilter>();

    public AllLocationFilter(LocationFilter... filters) {
