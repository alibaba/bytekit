...
import com.taobao.arthas.bytekit.agent.inst.InstrumentApi;
...
public class InstrumentImpl {
    ...
    public static MethodNode replaceInvokeOrigin(String originOwner, MethodNode originMethodNode,
        ...
        List<MethodInsnNode> methodInsnNodes = AsmUtils.findMethodInsnNode(apmMethodNode, InstrumentApi.class.getName().replace('.', '/')
                        , "invokeOrigin", "()Ljava/lang/Object;");
